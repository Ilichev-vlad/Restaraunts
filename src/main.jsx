...
ReactDOM.createRoot(document.getElementById('root')).render(
  <div>
    ...
    <ul>
      ...
      <li>{restaurants[0].reviews[1].user}: {restaurants[0].reviews[0].text}</li>
    </ul>
    {/* Ресторан 2 */}
    <div style={{borderTop: 'dashed', paddingTop: '0.5rem'}}>{restaurants[1].name}</div>
    <h3>MENU</h3>
    <ul>
    ...
    {/* Ресторан 3 */}
    <div style={{borderTop: 'dashed', paddingTop: '0.5rem'}}>{restaurants[2].name}</div>
    <h3>MENU</h3>
    <ul>
    ...
    {/* Ресторан 4 */}
    <div style={{borderTop: 'dashed', paddingTop: '0.5rem'}}>{restaurants[3].name}</div>
    <h3>MENU</h3>
    <ul>
